            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <path d="M6.04163 4.4585H13.9583" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M3.66663 10H16.3333" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M6.04163 15.5415H13.9583" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                        </motion.svg>
                    </motion.button>
                </motion.div>
                ...
                <PopoverGroup className="hidden lg:flex items-center lg:gap-x-[25px]">
                    ...
                    {['Features', 'How it Works', 'FAQs', 'Blogs'].map((item, index) => {
                        const links = ['#features', '#howitworks', 'https://buildsbyesuoladaniel.hashnode.space/provolo/faqs', 'https://substack.com/@provoloai'];
                            ...
                            >
                                ...
                                >
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M14.75 5.25L5.25064 14.7494M14.7494 14.75L5.25 5.25067" stroke="white" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </motion.button>
                            </motion.div>

                            <motion.div 
                                className="mt-10 flow-root relative z-50"
                                variants={navItemVariants}
                            >
                                <div className="">
                                    <motion.div 
